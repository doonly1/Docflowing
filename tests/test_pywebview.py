...
class TestScripts:
    ...
    def test_build_desktop_script_valid(self):
        """electron/build-desktop.py 语法正确"""
        script_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
            'electron', 'build-desktop.py'
        )
    ...
    def test_build_backend_script_valid(self):
        """electron/build-backend.py 语法正确"""
        script_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
            'electron', 'build-backend.py'
        )
        assert os.path.exists(script_path), "构建脚本应存在"
