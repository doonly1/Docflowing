...
a = Analysis(
    ...
    (os.path.join(SPECPATH, 'ui/js/updater.js'), 'ui/js'),
    (os.path.join(SPECPATH, 'ui/js/utils.js'), 'ui/js'),
    (os.path.join(SPECPATH, 'ui/lib/marked/marked.min.js'), 'ui/lib/marked'),
    (os.path.join(SPECPATH, 'ui/lib/quill/dist/quill.js'), 'ui/lib/quill/dist'),
    (os.path.join(SPECPATH, 'ui/lib/quill/dist/quill.snow.css'), 'ui/lib/quill/dist'),
    (os.path.join(SPECPATH, 'ui/lib/turndown/dist/turndown.js'), 'ui/lib/turndown/dist'),
